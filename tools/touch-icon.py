...
<g fill="none" stroke-linecap="square" stroke-linejoin="round" transform="translate(120 120) scale(0.86) translate(-120 -120)"><circle cx="120" cy="120" r="91" stroke="#5E7D45" stroke-width="14"/><circle cx="120" cy="120" r="71" stroke="#1B1E17" stroke-width="3"/><path d="M69 171V69l102 102V69" stroke="#1B1E17" stroke-width="18"/></g>
<g transform="translate(120 120) scale(0.86) translate(-120 -120)"><circle cx="120" cy="29" r="7" fill="#5E7D45"/><circle cx="120" cy="211" r="7" fill="#5E7D45"/></g></svg>"""
