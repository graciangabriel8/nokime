...
<g transform="translate(80,74)"><g transform="scale(0.1875)" fill="none" stroke-linecap="square" stroke-linejoin="round"><circle cx="120" cy="120" r="91" stroke="#A3BA6C" stroke-width="14"/><circle cx="120" cy="120" r="71" stroke="#ECEBE2" stroke-width="3"/><path d="M69 171V69l102 102V69" stroke="#ECEBE2" stroke-width="18"/><circle cx="120" cy="29" r="7" fill="#A3BA6C" stroke="none"/><circle cx="120" cy="211" r="7" fill="#A3BA6C" stroke="none"/></g>
